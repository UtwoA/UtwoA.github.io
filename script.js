const translations = {
  ru: {
    ...
    "focus.aguide": "Веб-направление: быстрые итерации и доработка функциональности.",
    ...
    "stack.subtitle": "Сгруппировано по направлениям и специализации",
    "stack.frontend": "Frontend",
    "stack.backend": "Backend",
    "stack.ml": "ML / AI",
    "stack.mlFlowTitle": "ML workflow в практических задачах",
    "stack.mlFlowText": "Полный цикл: от подготовки данных и построения признаков до оценки качества и интеграции модели в прикладной сервис.",
    "stack.mlFlow01": "Сбор данных и препроцессинг",
    "stack.mlFlow02": "Feature engineering и отбор признаков",
    "stack.mlFlow03": "Обучение и валидация",
    "stack.mlFlow04": "Оценка, тюнинг и интеграция",
    "stack.data": "Data",
    ...
    "projects.aguide": "Активная разработка веб-проекта и расширение функциональности.",
  ...
  en: {
    ...
    "focus.aguide": "Web direction: fast iterations and continuous feature growth.",
    ...
    "stack.subtitle": "Grouped by direction and specialization",
    "stack.frontend": "Frontend",
    "stack.backend": "Backend",
    "stack.ml": "ML / AI",
    "stack.mlFlowTitle": "ML workflow in production-oriented tasks",
    "stack.mlFlowText": "End-to-end cycle: from data preprocessing and feature design to model evaluation and integration into product services.",
    "stack.mlFlow01": "Data collection and preprocessing",
    "stack.mlFlow02": "Feature engineering and selection",
    "stack.mlFlow03": "Training and validation",
    "stack.mlFlow04": "Evaluation, tuning, and integration",
    "stack.data": "Data",
    "stack.devops": "DevOps / Infrastructure",
    "stack.extra": "Additional",
    ...
    "projects.aguide": "Actively evolving web project with ongoing feature development.",
